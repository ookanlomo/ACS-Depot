#### This article details the steps required to configure Alfresco Intelligence Service (AIS) to utilize textract services for manual metadata extraction 

### Use-Case / Requirement
The Alfresco system should perform AIS operations inorder to OCR content and assign metadata from the document based on the metadata found.
